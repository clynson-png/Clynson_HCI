...
function IndicesPage({
  ...
  return (
    <main className="dashboard dashboard-indices">
      ...
      <section className="dashboard-panel selector-panel">
      ...
      <section className="dashboard-panel">
        <div className="dashboard-panel-header">
          <div>
            ...
            <div className="dashboard-panel-subtitle">{t.quickGuide}</div>
          </div>
        </div>
      ...
      <section className="dashboard-panel dashboard-panel-summary">
        <div className="dashboard-panel-header">
          <div>
            <h2>{t.quickGuide}</h2>
            <div className="dashboard-panel-subtitle">{lang === 'en' ? 'Quick reference for all HCI indices' : 'Referência rápida para todos os índices HCI'}</div>
          </div>
        </div>
      ...
      <section className="dashboard-panel">
        ...
        <pre className="json-preview">
          {JSON.stringify(
            {
              athlete: athleteView.athlete,
              summary: athleteView.summary,
              indices: athleteView.indices,
            },
            null,
            2
          )}
...
function getIndicesTranslations(lang) {
  if (lang === 'en') {
    return {
      ...
      targets: 'Targets',
      structure: 'Structure',
      contract: 'ATHLETE_VIEW_JSON Contract',
  ...
  return {
    ...
    contract: 'Contrato ATHLETE_VIEW_JSON',
